...
document
  .querySelector("section#about > div.head")
  .addEventListener("mousedown", mouseDown_about);
document
  .querySelector("section#projects > div.head")
  .addEventListener("mousedown", mouseDown_projects);
document
  .querySelector("section#softskills > div.head")
  .addEventListener("mousedown", mouseDown_softskills);
document
  .querySelector("section#contact > div.head")
  .addEventListener("mousedown", mouseDown_contact);
...
function mouseMove_softskills(e) {
  if (window.innerWidth > 790) {
    ...
    startX_softskills = e.clientX;
    startY_softskills = e.clientY;
    softskills_card.style.top =
      softskills_card.offsetTop - newY_softskills + "px";
    softskills_card.style.left =
      softskills_card.offsetLeft - newX_softskills + "px";
  }
}
